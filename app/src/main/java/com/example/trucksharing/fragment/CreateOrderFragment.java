...
public class CreateOrderFragment extends Fragment {
    ...
    private static final String PICKUP_LOCATION = "LOCATION";
    ...
    public static CreateOrderFragment newInstance(int userId, String receiverName, String pickupDate, String pickupTime, String pickupLocation) {
    ...
    public void validateOrder() {
        ...
        Order newOrder = new Order(
                userId, receiverName,"", pickupLocation, pickupDate, pickupTime, goodType, vhicleType, "", weight, width, height, length, 1
        );
