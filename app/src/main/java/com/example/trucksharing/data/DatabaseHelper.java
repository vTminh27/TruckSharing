    ...
    public List<Order> fetchAllOrders(int userId) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                order.setPickupDate(cursor.getString(5));
                order.setPickupTime(cursor.getString(6));
                order.setGoodType(cursor.getString(7));
                order.setVehicleType(cursor.getString(8));
                order.setDriverName(cursor.getString(9));
                order.setWeight(cursor.getDouble(10));
                order.setWidth(cursor.getDouble(11));
                order.setHeight(cursor.getDouble(12));
                order.setLength(cursor.getDouble(13));
                order.setQuantity(cursor.getInt(14));
